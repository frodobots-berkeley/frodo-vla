    ...
    return ConfigDict(
        {
            ...
            "action_tokenizer": f"action_tokenizer.dct(action_dim=2, action_horizon={action_horizon}, save_path='gs://cat-logs/action-tokenizer-dct', pretrained_path='gs://cat-logs/action-tokenizer-dct')",
