...
def get_config():
    ...
    action_horizon = 8
    transform = ModuleSpec.create(gnm_dataset_transform, args={"action_horizon": action_horizon})
    return ConfigDict(
        {
            ...
            "action_tokenizer": "action_tokenizer.bin(min_action_value=-2, max_action_value=2, action_vocab_size=256)",
