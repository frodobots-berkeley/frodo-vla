...
def get_config(variant_config: str):
    ...
    data_dir = FieldReference("gs://cat-datasets/bridge_release/data/tfds", str)
    ...
    config = {
        ...
        "action_tokenizer": f"action_tokenizer.dct(action_dim=2, time_horizon=8, save_path='gs://cat-logs/action-tokenizer-dct', pretrained_path=None)",
